...
export enum CC {
  ...
  enemyBullet = 0b00000000000000000000000000100000, // 32
  enemySensor = 0b00000000000000000000000001000000, // 64

  item = 0b00000000000000000000000010000000, // 128

  door = 0b00000000000000000000000100000000, // 256
