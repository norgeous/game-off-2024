...
export enum CC {
  ...
  playerSensor = 0b00000000000000000000000000001000, // 8

  enemy = 0b000000000000000000000000000010000, // 16
  enemyBullet = 0b000000000000000000000000000100000, // 32
  enemySensor = 0b00000000000000000000000000001000000, // 64

  item = 0b0000000000000000000000000010000000, // 128

  door = 0b0000000000000000000000000100000000, // 256

  // sensor = 0b0000000000000000000000001000000000, // 512
